...
*/
  ...
  define('MODULE_PAYMENT_SAGE_PAY_SERVER_TEXT_PUBLIC_TITLE', 'Kartu Kredit dan Bank (diproses menggunakan Sage Pay)');
  ...
  define('MODULE_PAYMENT_SAGE_PAY_SERVER_ERROR_TITLE', 'Timbul masalah saat memproses Kartu Kredit Anda');
  define('MODULE_PAYMENT_SAGE_PAY_SERVER_ERROR_GENERAL', 'Silahkan coba kembali dan jika tetap gagal, silahkan gunakan metode pembayaran lain.');
?>
