...
define('HEADING_SHIPPING_INFORMATION', 'Order overzicht');
...
// javascript messages
define('JS_ERROR', 'Er hebben zich helaas fouten voorgedaan tijdens het verwerken!\nMaak de volgende aanpassingen:\n\n');
...
define('JS_ERROR_NO_PAYMENT_MODULE_SELECTED', '* Selecteer de betaalwijze voor uw bestelling.\n');
...
define('ERROR_NO_PAYMENT_MODULE_SELECTED', 'Selecteer de betaalwijze voor uw bestelling.');
...
define('ENTRY_PASSWORD_ERROR_NOT_MATCHING', 'Beide wachtwoorden moeten hetzelfde zijn.');
...
Welkom terug <span class="greetUser">%s !</span> Wilt u de <a href="%s"><u>nieuwe artikelen</u></a> zien die beschikbaar zijn?');
...
define('TEXT_GREETING_GUEST', 'deze tekst staat in catalog includes language dutch.php op regel 287 .');
