...
*/
  ...
  define('MODULE_PAYMENT_PAYPAL_EXPRESS_EMAIL_PASSWORD', 'Een account werd automatisch aangemaakt voor u met volgend e-mailadres en paswoord:' . "\n\n" . 'Winkel Account e-mailadres: %s' . "\n" . 'Winkel Account Paswoord: %s' . "\n\n");
